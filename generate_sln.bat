...
if not exist "%VS_PATH%" (echo [ERROR] Visual Studio 2022 not found. & exit /b 1)

:: --- Setup Environment ---
echo [INFO] Setting up VC++ Environment...
call "%VS_PATH%\VC\Auxiliary\Build\vcvars64.bat" || (echo [ERROR] vcvars64.bat failed. & exit /b 1)
